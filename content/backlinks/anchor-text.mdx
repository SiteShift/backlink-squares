...
description: >-
  Understand anchor text types, descriptive wording and backlink context. Review
  distribution as evidence rather than a target ratio when analysing your link
  profile.
