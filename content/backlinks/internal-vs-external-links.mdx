...
metaTitle: "Internal vs External Links: Complete SEO Guide [2026]"
...
## Find contextual internal links on your site

The [internal link opportunity finder](/tools/internal-link-finder) scans a sample of your site and returns existing passages that could link to a target page. Review each suggestion for reader value; navigation links alone do not replace useful contextual links.
