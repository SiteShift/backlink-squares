...
## Check real source pages

Use the [broken link finder](/tools/broken-link-finder) to check a bounded sample of pages and destinations. It separates confirmed 404/410 responses from blocks and timeouts. After earning a placement, use the [live backlink checker](/tools/live-backlink-checker) to inspect the source page and save its link attributes.
