---
title: 'Link Building Email Templates: Pitches and Follow-Ups'
description: >-
  Adapt email templates for guest posting, broken links and resource pages.
  Tailor each message to the recipient and explain a useful reason for the link.
metaTitle: 'Link Building Email Templates: Copy and Customise'
metaDescription: >-
  Adapt email templates for guest posting, broken links and resource pages.
  Tailor each message to the recipient and explain a useful reason for the link.
