---
title: 'Page Authority: Moz''s PA Metric Explained'
description: >-
  Learn what Moz's Page Authority measures, how to check PA and how it differs
  from domain metrics. Use the score for comparison, not as a Google ranking
  factor.
metaTitle: 'Page Authority (PA): Meaning, Checks & Limitations'
metaDescription: >-
  Learn what Moz's Page Authority measures, how to check PA and how it differs
  from domain metrics. Use the score for comparison, not as a Google ranking
  factor.
...
faqs:
  - question: What is Page Authority in SEO?
    answer: >-
      Page Authority (PA) is a metric developed by Moz that predicts how likely
      a specific webpage is to rank in search engine results. Scored from 0 to
      100 on a logarithmic scale, PA measures the ranking strength of an
      individual URL based on the quantity and quality of backlinks pointing to
      that specific page. Unlike Domain Authority which measures entire domains,
      PA focuses exclusively on page-level signals.
  - question: What is a good Page Authority score?
    answer: >-
      A 'good' PA score depends on your niche and competition. Generally: PA
      0-20 is low (new or poorly-linked pages), PA 20-40 is average (typical
      blog posts), PA 40-60 is strong (well-linked content), PA 60-80 is very
      strong (authoritative industry pages), and PA 80+ is exceptional (major
      publication pages, Wikipedia). Compare your PA to pages ranking for your
      target keywords rather than using absolute benchmarks.
  - question: How do I check Page Authority for free?
    answer: >-
      You can check Page Authority for free using: MozBar (free Chrome extension
      - shows PA for any page you visit), Moz Link Explorer free tier (10
      queries per month), or Small SEO Tools Page Authority Checker. For the
      most accurate data, use Moz's official tools since PA is their proprietary
      metric.
  - question: How can I improve my Page Authority?
    answer: >-
      Improve Page Authority by: 1) Building quality backlinks directly to the
      specific page (not just your homepage), 2) Getting internal links from
      your highest-PA pages, 3) Creating link-worthy content that naturally
      attracts backlinks, 4) Earning links from high-PA pages on external sites.
      PA improvements require sustained effort—expect gradual increases over 3-6
      months of link building.
  - question: What is the difference between Page Authority and Domain Authority?
    answer: >-
      Page Authority (PA) measures the ranking potential of a single URL/page,
      while Domain Authority (DA) measures the ranking potential of an entire
      domain. PA is based on links pointing to that specific page; DA considers
      all links to the entire website. A high-DA site can have low-PA pages (new
      content), and theoretically a low-DA site could have one high-PA page that
      went viral.
  - question: Why did my Page Authority score drop?
    answer: >-
      PA fluctuations happen due to: 1) Lost backlinks to that specific page, 2)
      Moz algorithm updates recalibrating scores, 3) Comparative changes (other
      pages gaining more links), 4) Link quality reassessment (Moz detecting
      lower-quality links). Check if you've lost important backlinks using Moz
      Link Explorer. Minor fluctuations (1-3 points) are normal; investigate
      drops of 5+ points.
  - question: Does Page Authority affect Google rankings?
    answer: >-
      Page Authority is not a Google ranking factor—Google doesn't use PA in its
      algorithm. PA is Moz's prediction of ranking potential based on their
      analysis of ranking signals. However, the underlying factors PA measures
      (quality backlinks to a page) do influence Google rankings. Think of PA as
      a useful proxy for link strength, not a direct ranking signal.
  - question: How long does it take to increase Page Authority?
    answer: >-
      Increasing PA typically takes 2-6 months depending on your link building
      activity. Moz updates their link index regularly, but it takes time to: 1)
      Build new backlinks, 2) Have those links discovered by Moz's crawler, 3)
      Have PA recalculated. Expect to see PA changes 4-8 weeks after acquiring
      significant new backlinks. Focus on sustained link building rather than
      expecting immediate PA jumps.
---
