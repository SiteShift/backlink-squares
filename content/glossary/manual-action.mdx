...
description: >-
  Understand Google manual actions, where to check them in Search Console and
  how the review process works. Distinguish a notice from an unexplained ranking
  change.
