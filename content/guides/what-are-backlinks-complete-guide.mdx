...
A backlink is a hyperlink from one website to another. When Site A links to Site B, Site B has received a [backlink](/glossary/backlink) from Site A. It's that simple.
