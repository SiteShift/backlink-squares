...
### 5. [Private Blog Networks (PBNs)](/glossary/pbn)

**Explicitly prohibited in all forms.**

A [PBN](/glossary/pbn) is any network of sites whose primary purpose is manipulating rankings through links. This includes:
...
- **Link Devaluation**: [Spammy links](/glossary/spammy-backlinks) simply ignored (no value passed)
- **Ranking Adjustments**: Pages/sections may lose rankings
- **Reduced Crawl Priority**: Less attention from Googlebot
- **[Trust](/glossary/trust-flow) Reduction**: Future links from your domain weighted less

### [Manual Actions](/glossary/manual-action)

For severe or obvious violations, Google issues [manual actions](/glossary/manual-action):
...
1. **Original Research**: Data and studies journalists and bloggers cite — see [Original Research for Links](/link-building-tactics/original-research)
2. **Comprehensive Guides**: Resources that become reference points
3. **Free Tools**: Useful tools that earn natural attribution — try our [Free Backlink Analyzer](/tools/backlink-analyzer)
4. **Expert Content**: Thought leadership others want to reference

Learn more: [Content That Earns Links](/link-building/content-that-earns-links) | [Linkable Assets Guide](/link-building/linkable-assets)
...
- [Link Scheme: Definition & Examples](/glossary/link-scheme)
- [What Is Link Spam?](/glossary/link-spam)
- [Manual Action Recovery Guide](/glossary/penalty-recovery)
- [Best Free Backlink Checkers](/blog/best-free-backlink-checkers) — monitor your profile for free
