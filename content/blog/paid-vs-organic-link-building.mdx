...
## Comparing directory submission fees?

Use [free versus paid directory submissions](/blog/free-vs-paid-directory-submissions) for checked examples of free profiles, priority review and paid-only routes. Paying for review, advertising and a research database buys different deliverables; none automatically establishes a ranking benefit.
