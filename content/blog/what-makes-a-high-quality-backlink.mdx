...
There is no universal safe anchor-text percentage. Review whether the wording describes the destination naturally and whether an acquisition method is creating repeated, commercially controlled anchors. A percentage alone cannot establish manipulation.

Read the source pages before changing links. A product name can legitimately recur across independent reviews; a low exact-match percentage does not make a paid link scheme acceptable.
...
This scorecard is an internal prioritisation aid, not a validated Google model. Use the individual findings to decide whether the opportunity fits; no score guarantees value or safety.
