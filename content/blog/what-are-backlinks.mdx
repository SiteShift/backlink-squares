...
A [backlink](/glossary/backlink) (also called an "inbound link" or "incoming link") is simply a link from one website to another. When website A links to website B, website B has received a backlink from website A.
