...
### Compare actual sources, not conversion formulas

There is no defensible universal exchange rate between links from different DR bands. A metric cannot establish how a particular link will affect rankings or how long it will remain live. Inspect relevance, source quality and destination usefulness, then verify important placements over time.
