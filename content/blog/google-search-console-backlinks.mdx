...
## Troubleshoot a missing placement

If a live placement is absent from the report, work through [backlinks not showing in Google Search Console](/blog/backlinks-not-showing-google-search-console). It separates source-page checks, property scope and report coverage so you can investigate the right issue.
