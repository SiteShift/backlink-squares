...
See our full guide on [UGC links and the rel="ugc" attribute](/glossary/ugc-link) for implementation details.
...
**Healthy Profile:**
Choose the destination that best serves the reader. There is no universal homepage-to-deep-link ratio; the appropriate distribution depends on what other pages are referencing.
- Varies by site type
