...
description: >-
  Backlink statistics describe the links observed in a particular dataset. They
  do not describe every link on the web, and they do not establish that a new
  link will cause a particular ranking increase.
metaTitle: 'Backlink Statistics: Counts, Coverage and Interpretation'
metaDescription: >-
  Understand backlink statistics with clear formulas, labeled examples and
