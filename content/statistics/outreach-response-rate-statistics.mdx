...
description: >-
  Outreach response rate statistics are only comparable when they use the same
  denominator and definition of a reply. Automatic replies, refusals, positive
  responses and published placements describe different stages of a campaign.
metaTitle: 'Outreach Response Rate Statistics: Calculate and Compare'
metaDescription: >-
  Understand outreach response rate statistics with clear formulas, labeled
