  ...
  return <aside className="article-offers hidden lg:block" aria-label="Link building resources">
    <div className="sticky top-36 space-y-4">
      <div className="rounded-xl bg-surface-950 p-6 text-white">
        ...
        <p className="text-xs uppercase tracking-widest text-white/60">Your next shortlist</p>
        ...
        <Link href="/bundle#preview" className="block mt-3 text-sm text-white/70 underline underline-offset-4">See the free sample</Link>
        <p className="text-xs text-white/50 mt-4">One-time payment. Download immediately after checkout.</p>
      </div>
