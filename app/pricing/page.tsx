...
const pricingTiers = [
  ...
  },
  {
    ...
    price: 10,
    dimensions: 'Popular',
    description: 'Flexible placement anywhere',
    features: [
      'Everything in 1 Square',
      'Place squares anywhere on grid',
      'Scatter or group them together',
      '10x the visibility',
    ],
    popular: true,
    color: 'yellow',
  },
  {
    ...
    price: 25,
    dimensions: 'Premium',
    description: 'Dominate the grid',
    features: [
      'Everything in 10 Squares',
      'Maximum grid presence',
