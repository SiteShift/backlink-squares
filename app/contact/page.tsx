...
import { Mail, Share2 as Twitter, HelpCircle, ArrowRight, Package, Search, ShoppingCart } from 'lucide-react'
...
const actionCards = [
  {
    ...
    description: 'Claim a permanent sponsored square on the grid right now.',
    cta: 'Open the grid',
    style: 'bg-white',
  },
  {
    ...
    description: 'Buy the backlink research spreadsheet.',
    cta: 'View the bundle',
